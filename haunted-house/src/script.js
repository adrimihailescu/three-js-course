 ...
 * House
 */
//first create a group as an empty object
const house = new THREE.Group();
scene.add(house);
/**
 * Walls
 */
//second create the walls and add to the house, from a cube/box
 ...
 * Roof
 */
//create the roof from a cone and basic material and add to the house
const roof = new THREE.Mesh(
  //the cone is 1 unit heigh
  new THREE.ConeGeometry(3.5, 1, 4),
  new THREE.MeshStandardMaterial({ color: "#b35f45" })
);
//position the roof on top of the house
roof.position.y = 2.5 + 0.5;
//rotate the roof on top of the house
 ...
 * Door Light
 */
//create a point light and add it to the house
