...
gui.add(material, "aoMapIntensity").min(0).max(10).step(0.00001);
gui.add(material, "displacementScale").min(0).max(10).step(0.00001);
...
const tick = () => {
  ...
  //Update objects
  // this makes the geometries rotate on x and y axis
